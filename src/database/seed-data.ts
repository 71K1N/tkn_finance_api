...
export const CATEGORY_TAXONOMY: CategorySeed[] = [
  {
    ...
    subcategories: [
      {
        name: 'Aluguel',
        description: 'Pagamento mensal de aluguel do imóvel.',
      },
  ...
  },
  {
    ...
    subcategories: [
      {
        name: 'Supermercado',
        description: 'Compras de mantimentos e produtos para casa.',
      },
      {
        name: 'Restaurante',
        description: 'Refeições fora de casa, delivery e restaurantes.',
      },
  ...
  },
  {
    ...
    subcategories: [
      { name: 'Combustível', description: 'Abastecimento de veículo.' },
      {
        ...
        description: 'Ônibus, metrô, trem e afins.',
      },
      {
        name: 'Aplicativo de Transporte',
        description: 'Uber, 99 e serviços similares.',
      },
      {
    ...
    subcategories: [
      {
        ...
        description: 'Mensalidade de escola, faculdade ou curso.',
      },
      {
        name: 'Material Didático',
        description: 'Livros, apostilas e materiais escolares.',
      },
      {
        name: 'Cursos e Certificações',
        description: 'Cursos livres, certificações e treinamentos.',
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        name: 'Streaming',
        description: 'Assinaturas de streaming de vídeo e música.',
      },
      {
        name: 'Cinema e Shows',
        description: 'Ingressos para cinema, shows e eventos.',
      },
  ...
  },
  {
    ...
    subcategories: [
      {
        name: 'Diversos',
        description: 'Gastos variados sem categoria específica.',
      },
